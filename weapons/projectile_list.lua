...
for _, weaponUpgrade in ipairs(WeaponUpgrades) do
   local projectile_savenames = weaponUpgrade.projectile_savenames
   local projectile_savename = projectile_savenames[1] -- TODO: support splitting projectiles
   if not added_projectiles[projectile_savename] then
      added_projectiles[projectile_savename] = true
      local base_projectile = FindProjectile(projectile_savename)
